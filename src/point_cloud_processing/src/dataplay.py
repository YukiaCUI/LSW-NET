...
class ScanData(object):
    def __init__(self, input_data, data_length, batch_size, raw_length, sample_times, inf=35):
        """
        激光数据
...
#     raw_length = 768
#     sample_times = 5
#     scan = ScanData(input_data, data_length, batch_size, raw_length, sample_times)
