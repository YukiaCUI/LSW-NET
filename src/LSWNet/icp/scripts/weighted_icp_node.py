...
class ICP_Node() : 
    def __init__(self) : 
        ...
        self.pub = rospy.Publisher('weighted_icp_odom', Odometry, queue_size=10)
        self.odom_broadcaster = TransformBroadcaster()
        self.odom = np.identity(3)
        self.first_frame = True

        self.save_poses = True
        self.file_name = "/home/shiwb/weighted_icp.txt"
    ...
    def laserScanCallBack(self, msg) :
        ...
        if self.first_frame : 
            ...
            T, distances, iterations = icp.icp_with_weight(self.B, self.A, self.W, tolerance=0.000001)
            end_time = time.time()
    ...
    def convertScan2PointCloud(self, msg) :
        ...
        for i in range(len(msg.ranges)) :
            ...
            if r > msg.range_min and r < msg.range_max : 
                ...
                pc.append(point)
                point_weight = max(0.1, min(msg.intensities[i], 0.4))  # 限幅
                w.append(point_weight)
