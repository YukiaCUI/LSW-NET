...
options = {
  ...
  pose_publish_period_sec = 0.005, -- 5e-3,
  trajectory_publish_period_sec = 0.03, -- 30e-3,
...
-- TRAJECTORY_BUILDER_2D.motion_filter.max_time_seconds = 0.00001
-- TRAJECTORY_BUILDER_2D.motion_filter.max_distance_meters = 0.00001
-- TRAJECTORY_BUILDER_2D.motion_filter.max_angle_radians = 0.00001
