...
//  size_t residual_composition0=0;
//  size_t residual_composition1=0;
//  size_t residual_composition2=0;
//  size_t residual_composition3=0;
//  std::vector<int> residual_composition; // 创建一个大小为4，所有元素都初始化为0的vector
  ...
  visualization_msgs::MarkerArray GetTrajectoryNodeList(geometry_msgs::PoseArray &pose_array,
